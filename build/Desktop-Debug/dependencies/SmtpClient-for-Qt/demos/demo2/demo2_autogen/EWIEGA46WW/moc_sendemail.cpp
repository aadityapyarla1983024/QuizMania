...
#include <memory>
#include "../../../../../../../../dependencies/SmtpClient-for-Qt/demos/demo2/sendemail.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SendEmail_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SendEmail_t qt_meta_stringdata_SendEmail = {
    {
        QT_MOC_LITERAL(0, 9),  // "SendEmail"
        QT_MOC_LITERAL(10, 24),  // "on_addAttachment_clicked"
        QT_MOC_LITERAL(35, 0),  // ""
        QT_MOC_LITERAL(36, 20)   // "on_sendEmail_clicked"
    },
    "SendEmail",
...
Q_CONSTINIT static const uint qt_meta_data_SendEmail[] = {
...
Q_CONSTINIT const QMetaObject SendEmail::staticMetaObject = { {
    ...
    qt_meta_stringdata_SendEmail.offsetsAndSizes,
    qt_meta_data_SendEmail,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SendEmail_t,
        // Q_OBJECT / Q_GADGET
